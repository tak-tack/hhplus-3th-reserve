...
//        if (kafkaConfig.getConsumer() == null || kafkaConfig.getConsumer().getGroupId() == null) {
//            throw new IllegalStateException("Kafka Consumer configuration is missing or incomplete");
//        }
//        // kafka 컨슈머 설정을 위한 맵 생성
//        Map<String, Object> props = new HashMap<>();
//        //
//        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaConfig.getBootstrapServers());
//        props.put(ConsumerConfig.GROUP_ID_CONFIG, kafkaConfig.getConsumer().getGroupId().getSuccess());
